            ...
            liveElement.innerHTML = `
              ...
              <div style="display: flex; flex-wrap: nowrap;margin-right: auto; width: 100%;padding: 0px;">
                ...
                padding-right: 20px;align-items: center; padding-bottom: 0px;height: 141px;">
                  ...
                  <button class="buttongoweb" onclick="goToLink('drecentlive.html?id=${live.id}&start=${live.live_info?.date?.start ?? ''}&end=${live.live_info?.date?.end ?? ''}&gift=${giftRate}&view=${viewers}&nama=${live.member?.nickname ?? ''}&image=${live.member?.img_alt ?? ''}&points=${points}&type=${type}&title=${title}&imgidn=${imgidn}&imgsr=${imgsr}')">
